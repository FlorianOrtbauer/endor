...
urlpatterns +=[
    ...
    url(r'clients/(?P<pk>)/$', views.ClientDetail.as_view(), name='client-list'),
    url(r'sites/$', views.SitesList.as_view(), name='site-list'),
    url(r'sites/(?P<pk>)/$', views.SiteDetail.as_view(), name='site-list'),
    url(r'areas/$', views.AreasList.as_view(), name='area-list'),
    url(r'areas/(?P<pk>)/$', views.AreaDetail.as_view(), name='area-list'),
    ...
    url(r'tasks/(?P<pk>)/$', views.TaskDetail.as_view(), name='task-list'),
]